...
<meta name="csrf-token" content="qN+/7gTXZbj2seEMlDjmP8FDLi9QjFkC39h/ENDT/aY=">
  ...
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery-1.4.2.min.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.autocomplete.min.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.numeric.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.mapkey.min.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.simplemodal.min.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.sparkline.min.js" type="text/javascript"></script>
  
    <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.flot.min.js" type="text/javascript"></script>
    <script src="http://demo.fluent.netspective.com/medi/index_files/jquery.flot.selection.min.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/backtotop.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/application.js" type="text/javascript"></script>
  <script src="http://demo.fluent.netspective.com/medi/index_files/rails.js" type="text/javascript"></script>
</head>
<body>
...
<ul id="modal-host-chooser-list">
    <li><a href="http://demo.fluent.netspective.com/hosts/PUBLISHER/messages">PUBLISHER</a></li>
    <li><a href="http://demo.fluent.netspective.com/hosts/SUBSCRIBER/messages">SUBSCRIBER</a></li>
</ul>
</div>
...
<script src="http://demo.fluent.netspective.com/medi/index_files/messageupdater.js" type="text/javascript"></script>
